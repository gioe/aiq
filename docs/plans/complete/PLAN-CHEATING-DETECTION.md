...
**Acceptance Criteria:**
- [x] `validity_status` column added with default "valid"
- [x] `validity_flags` JSON column added (nullable)
- [x] `validity_checked_at` datetime column added (nullable)
- [x] Model can store list of flag types in validity_flags
