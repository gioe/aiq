...
public struct Client: APIProtocol {
    ...
    /// Requires X-Admin-Token header with valid admin token.
    ///
    /// - Remark: HTTP `GET /v1/admin/token-blacklist/stats`.
    /// - Remark: Generated from `#/paths//v1/admin/token-blacklist/stats/get(get_token_blacklist_stats_v1_admin_token_blacklist_stats_get)`.
    public func getTokenBlacklistStatsV1AdminTokenBlacklistStatsGet(_ input: Operations.GetTokenBlacklistStatsV1AdminTokenBlacklistStatsGet.Input) async throws -> Operations.GetTokenBlacklistStatsV1AdminTokenBlacklistStatsGet.Output {
        try await client.send(
            input: input,
            forOperation: Operations.GetTokenBlacklistStatsV1AdminTokenBlacklistStatsGet.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/v1/admin/token-blacklist/stats",
                    parameters: []
                )
                var request: HTTPTypes.HTTPRequest = .init(
                    soar_path: path,
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.GetTokenBlacklistStatsV1AdminTokenBlacklistStatsGet.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Components.Schemas.TokenBlacklistStatsResponse.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
                ...
                case 422:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.GetTokenBlacklistStatsV1AdminTokenBlacklistStatsGet.Output.UnprocessableContent.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
    ...
    ///
    /// - Remark: HTTP `GET /v1/admin/user-flags/{user_id}/cooldown-bypass`.
    /// - Remark: Generated from `#/paths//v1/admin/user-flags/{user_id}/cooldown-bypass/get(get_cooldown_bypass_v1_admin_user_flags__user_id__cooldown_bypass_get)`.
    public func getCooldownBypassV1AdminUserFlagsUserIdCooldownBypassGet(_ input: Operations.GetCooldownBypassV1AdminUserFlagsUserIdCooldownBypassGet.Input) async throws -> Operations.GetCooldownBypassV1AdminUserFlagsUserIdCooldownBypassGet.Output {
        try await client.send(
            input: input,
            forOperation: Operations.GetCooldownBypassV1AdminUserFlagsUserIdCooldownBypassGet.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/v1/admin/user-flags/{}/cooldown-bypass",
                    parameters: [
                        input.path.userId
                    ]
                )
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.GetCooldownBypassV1AdminUserFlagsUserIdCooldownBypassGet.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                ...
                case 422:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.GetCooldownBypassV1AdminUserFlagsUserIdCooldownBypassGet.Output.UnprocessableContent.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
    ...
    ///     404: If the user does not exist
    ///
    /// - Remark: HTTP `PATCH /v1/admin/user-flags/{user_id}/cooldown-bypass`.
    /// - Remark: Generated from `#/paths//v1/admin/user-flags/{user_id}/cooldown-bypass/patch(set_cooldown_bypass_v1_admin_user_flags__user_id__cooldown_bypass_patch)`.
    public func setCooldownBypassV1AdminUserFlagsUserIdCooldownBypassPatch(_ input: Operations.SetCooldownBypassV1AdminUserFlagsUserIdCooldownBypassPatch.Input) async throws -> Operations.SetCooldownBypassV1AdminUserFlagsUserIdCooldownBypassPatch.Output {
        try await client.send(
            input: input,
            forOperation: Operations.SetCooldownBypassV1AdminUserFlagsUserIdCooldownBypassPatch.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/v1/admin/user-flags/{}/cooldown-bypass",
                    parameters: [
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.SetCooldownBypassV1AdminUserFlagsUserIdCooldownBypassPatch.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                ...
                case 422:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.SetCooldownBypassV1AdminUserFlagsUserIdCooldownBypassPatch.Output.UnprocessableContent.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
    ...
    public func transferOwnershipV1GroupsGroupIdTransferOwnershipPut(_ input: Operations.TransferOwnershipV1GroupsGroupIdTransferOwnershipPut.Input) async throws -> Operations.TransferOwnershipV1GroupsGroupIdTransferOwnershipPut.Output {
        try await client.send(
            input: input,
            forOperation: Operations.TransferOwnershipV1GroupsGroupIdTransferOwnershipPut.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/v1/groups/{}/transfer-ownership",
                    parameters: [
                        input.path.groupId
                    ]
                )
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.TransferOwnershipV1GroupsGroupIdTransferOwnershipPut.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                ...
                case 422:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.TransferOwnershipV1GroupsGroupIdTransferOwnershipPut.Output.UnprocessableContent.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
