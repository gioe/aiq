...
/// to the concrete `NetworkMonitor` type. If a mock implementation is registered that doesn't
/// inherit from `NetworkMonitor`, state updates won't propagate via Combine subscriptions.
