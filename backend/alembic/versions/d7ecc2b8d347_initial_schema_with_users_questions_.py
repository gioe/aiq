...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_questions_is_active"), "questions", ["is_active"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_user_questions_id"), "user_questions", ["id"], unique=False
    )
    op.create_index(
        "ix_user_questions_user_id", "user_questions", ["user_id"], unique=False
    )
    op.create_table(
        "responses",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_test_results_user_id"), "test_results", ["user_id"], unique=False
    )
