...
class TestRegisterDeviceToken:
    ...
    async def test_register_device_token_success(self, client, auth_headers, test_user):
    ...
    async def test_register_device_token_updates_existing(
    ...
    async def test_register_device_token_persisted_in_database(
        self, client, auth_headers, test_user, db_session
    ):
    ...
    async def test_register_device_token_normalized_to_lowercase(
        self, client, auth_headers, test_user, db_session
    ):
    ...
    async def test_register_device_token_too_short(self, client, auth_headers):
    ...
    async def test_register_device_token_too_long(self, client, auth_headers):
    ...
    async def test_register_device_token_invalid_characters(self, client, auth_headers):
    ...
    async def test_register_device_token_with_spaces(self, client, auth_headers):
    ...
    async def test_register_device_token_empty_string(self, client, auth_headers):
    ...
    async def test_register_device_token_missing_field(self, client, auth_headers):
    ...
    async def test_register_device_token_unauthenticated(self, client):
    ...
    async def test_register_device_token_invalid_token(self, client):
...
class TestUnregisterDeviceToken:
    ...
    async def test_unregister_device_token_when_none_registered(
        self, client, auth_headers, test_user, db_session
    ):
    ...
    async def test_unregister_device_token_unauthenticated(self, client):
        """Test that unauthenticated requests are rejected."""
        response = await client.delete("/v1/notifications/register-device")

        assert response.status_code == 403  # Missing auth

    async def test_unregister_device_token_invalid_token(self, client):
        """Test that requests with invalid auth token are rejected."""
        headers = {"Authorization": "Bearer invalid_token_here"}
        response = await client.delete(
            "/v1/notifications/register-device",
...
class TestUpdateNotificationPreferences:
    ...
    async def test_update_notification_preferences_enable(
        self, client, auth_headers, test_user, db_session
    ):
    ...
    async def test_update_notification_preferences_disable(
        self, client, auth_headers, test_user, db_session
    ):
    ...
    async def test_update_notification_preferences_toggle(
    ...
    async def test_update_notification_preferences_missing_field(
    ...
    async def test_update_notification_preferences_unauthenticated(self, client):
        """Test that unauthenticated requests are rejected."""
        response = await client.put(
            "/v1/notifications/preferences",
            json={"notification_enabled": False},
    ...
    async def test_update_notification_preferences_invalid_token(self, client):
        """Test that requests with invalid auth token are rejected."""
        headers = {"Authorization": "Bearer invalid_token_here"}
        response = await client.put(
            "/v1/notifications/preferences",
...
class TestGetNotificationPreferences:
    ...
    async def test_get_notification_preferences_enabled(
        self, client, auth_headers, test_user
    ):
    ...
    async def test_get_notification_preferences_disabled(
        self, client, auth_headers, test_user, db_session
    ):
    ...
    async def test_get_notification_preferences_unauthenticated(self, client):
        """Test that unauthenticated requests are rejected."""
        response = await client.get("/v1/notifications/preferences")

        assert response.status_code == 403  # Missing auth

    async def test_get_notification_preferences_invalid_token(self, client):
        """Test that requests with invalid auth token are rejected."""
        headers = {"Authorization": "Bearer invalid_token_here"}
        response = await client.get(
            "/v1/notifications/preferences",
...
class TestNotificationIntegration:
    ...
    async def test_register_token_and_disable_notifications_independently(
        self, client, auth_headers, test_user, db_session
    ):
    ...
    async def test_unregister_token_keeps_notification_preference(
        self, client, auth_headers, test_user, db_session
    ):
    ...
    async def test_different_users_tokens_isolated(self, client, test_user, db_session):
        ...
        db_session.expire_all()
        _result = await db_session.execute(select(User).filter(User.id == test_user.id))
        user1_db = _result.scalars().first()
        _result = await db_session.execute(select(User).filter(User.id == user2.id))
        user2_db = _result.scalars().first()
