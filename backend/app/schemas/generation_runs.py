...
class QuestionGenerationRunCreate(BaseModel):
    ...
    # Correlation ID generated by the question-service at run start
    client_run_id: Optional[str] = Field(
        None,
        max_length=100,
        description="Correlation ID generated at script start (e.g. run-20260329-143022-abc123)",
    )
...
class QuestionGenerationRunRead(BaseModel):
    ...
    client_run_id: Optional[str] = Field(
        None, description="Correlation ID from question-service"
    )
