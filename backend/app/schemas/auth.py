...
from app.models.models import EducationLevel
...
class AppleOAuthTokenExchange(OAuthTokenExchange):
    """Schema for exchanging an Apple identity token with replay nonce binding."""
    ...
    nonce: str = Field(
        ...
        max_length=256,
        description=(
            "Raw nonce generated by the client. The verifier hashes this value "
            "and compares it to the nonce claim in Apple's identity token."
        ),
    )
