...
# Redis for Distributed Rate Limiting (optional but recommended for multi-worker)
# If not set, rate limiter falls back to in-memory storage (won't work correctly across workers)
